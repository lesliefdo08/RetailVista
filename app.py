...
<div class="hero-section">
    ...
    <div class="author-tag">
        👨‍💻 Crafted with ❤️ by Leslie Fernando
    </div>
</div>
""", unsafe_allow_html=True)
...
with tab1:
    ...
    with col1:
        ...
        item_type = st.selectbox(
            "What category does it belong to? 🏷️", 
            [
...
with tab2:
    ...
    st.markdown("""
    <div class="feature-card">
        <h4 style="color: #667eea;">🧙‍♂️ Welcome to the Batch Processing Wizard!</h4>
...
with tab3:
    ...
    <div class="feature-card">
        ...
        <p style="font-size: 1.1rem; color: #666; margin-bottom: 2rem;">
            Ever wondered why some products fly off the shelves while others collect dust? Here's the inside scoop! 🕵️‍♀️
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    with factors_col1:
        ...
        <div style="background: linear-gradient(45deg, #667eea, #764ba2); color: white; padding: 1.5rem; border-radius: 15px; margin: 1rem 0;">
            <h4>🏷️ Product Factors</h4>
            <ul style="list-style: none; padding: 0;">
                <li>⚖️ <strong>Weight:</strong> Heavy ≠ Always Better</li>
                <li>🥑 <strong>Fat Content:</strong> Health trends matter</li>
                <li>👀 <strong>Visibility:</strong> Location, location, location!</li>
                <li>🏷️ <strong>Category:</strong> Some types just sell more</li>
            </ul>
        </div>
        """, unsafe_allow_html=True)
    ...
    st.markdown("""
    <div class="feature-card">
        <h3 style="color: #607D8B;">⚠️ A Friendly Reminder</h3>
...
<div style="margin-top: 4rem; padding: 2rem; text-align: center; 
    ...
    <h4 style="color: white; margin-bottom: 1rem;">Made with ❤️ and lots of ☕ by Leslie Fernando</h4>
